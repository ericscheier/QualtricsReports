...
title: "Survey Report"
author: &default_author "learningforpurpose.org"
date: &default_date '`r format(Sys.Date(), "%d %B %Y")`'

# Last page uses author and date from above entries. You can add or remove as you see fit.
lastpage-data:
  - *default_author
...
# Code highlighting color definitions
color-shade: 'F8F8F8'
...
# Commands: \lhead, \chead, \rhead, \lfoot, \cfoot, \rfoot
header-includes:
    - \lhead{This is fancy}
